...
CREATE TABLE `inscriptions` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `laboratoire` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `other_laboratoire` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_specialite` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_method` enum('laboratoire','virement','invite','sur-place') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `status` enum('pending','accepted','refused') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `rib_pdf_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `laboratoire_status` enum('encours','confirme') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `masterclasses` WRITE;
/*!40000 ALTER TABLE `masterclasses` DISABLE KEYS */;
/*!40000 ALTER TABLE `masterclasses` ENABLE KEYS */;
UNLOCK TABLES;
