...
class InscriptionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'arrival_date' => 'nullable|date|in:2026-03-26',
            'departure_date' => 'nullable|date|in:2026-03-29',
            ...
            'rib_pdf' => [
                ...
                'max:2048',
                function ($attribute, $value, $fail) {
                    if (request('payment_method') === 'virement' && !$value) {
                        $fail('Le fichier RIB est requis pour le paiement par virement.');
                    }
                },
            ],
        ];
    ...
    public function messages(): array
    {
        return [
            ...
            'arrival_date.in' => 'La date d\'arrivée doit être : 2026-03-26.',

            'departure_date.date' => 'La date de départ doit être une date valide.',
            'departure_date.in' => 'La date de départ doit être : 2026-03-29.',
            ...
            'rib_pdf.max' => 'Le fichier RIB ne peut pas dépasser 2 Mo.',
        ];
    }
}
