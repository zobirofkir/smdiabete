    ...
    <div class="min-h-screen flex md:flex-row flex-col items-center justify-center bg-gradient-to-r from-blue-50 to-purple-50 p-6">
        ...
        <div class="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 bg-white rounded-lg shadow-2xl overflow-hidden transition-transform duration-500 hover:scale-105">
            ...
            <div class="p-8 flex flex-col justify-center relative">
                ...
                <h2 class="text-3xl font-bold text-gray-800 mb-6 animate-fade-in-down">Inscription SMD Paramédical</h2>
                <form class="space-y-6" action="{{ route('paramedical.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- username -->
                    <div class="animate-fade-in-left delay-100">
                        <label for="username" class="block text-sm font-medium text-gray-700">Nom & Prénom</label>
                    ...
                    <div class="animate-fade-in-left">
                        <label for="responsable" class="block text-sm font-medium text-gray-700">Nom du Médecin Responsable</label>
            ...
            <div class="block overflow-hidden relative animate-fade-in-right">
                <img src="{{ asset('assets/images/affiche/communication-inscription-paramedical.jpeg') }}" alt="Affichage"
