<x-app-layout>
    <div class="min-h-screen flex flex-col items-center py-8 relative bg-gray-50">
        ...
        <div id="inscription-modal" class="fixed inset-0 flex justify-center items-center bg-gray-900 bg-opacity-50 z-50 hidden">
            <div class="bg-white shadow-2xl rounded-xl p-6 sm:p-8 w-full max-w-md md:max-w-md h-auto md:h-auto mx-4 transform transition-transform duration-500 scale-95 opacity-0 modal-content relative">
