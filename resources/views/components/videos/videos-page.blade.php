    ...
    <div>
        ...
        $videoFolders = [
            ...
            'folder2' => [
                ...
                ['url' => 'https://youtu.be/PVMmfaC_EEM?si=y4tFFHHyB6OhmiFB', 'image' => 'assets/images/events/last-event-2.jpeg', 'title' => '1er congrès de Diabétologie'],
                ...
                ['url' => 'https://youtu.be/EXTTBPPOrRA?si=sfOHAaIWyxSDTLkN', 'image' => 'assets/images/events/last-event-2.jpeg', 'title' => 'ASTRAZENECA Comment protéger le cœur de nos diabétiques Pr Mohammed Alami'],
                ['url' => 'https://youtu.be/5G1Rv8Gjf_c?si=cFA_ruuao-jrHph_', 'image' => 'assets/images/events/last-event-2.jpeg', 'title' => "BOEHRINGER Isglt au cœur de la prise en charge du rien diabétique Point de vue de l'endocrinologue"],
                ['url' => 'https://youtu.be/lI2-Bu3CJBM?si=ebgE15qUOFmaFQWC', 'image' => 'assets/images/events/last-event-2.jpeg', 'title' => "BOEHRINGER Isglt au cœur de la prise en charge du rien diabétique Point de vue du néphrologue"],
                ...
                ['url' => 'https://youtu.be/EFi56ebRDZQ?si=71XNaBwYkDMvuPNZ', 'image' => 'assets/images/events/last-event-2.jpeg', 'title' => 'SANOFI Place des nouvelles insulines dans la prise en charge du diabète de type 2 Pr.INES KHOCHTALI'],
                ['url' => 'https://youtu.be/BJnR4oAYO5Y?si=Lro8-zV8DvONlNuH', 'image' => 'assets/images/events/last-event-2.jpeg', 'title' => "SANOFI Optimisation de la gestion du Diabète de type 2 l'IglarLixi Pr Fayçal El Guendouz"],
                ...
                ['url' => 'https://youtu.be/lkwNn4DDIzc?si=rNHrNyrZr5RWguTA', 'image' => 'assets/images/events/last-event-2.jpeg', 'title' => 'Best of SMD 2024'],
