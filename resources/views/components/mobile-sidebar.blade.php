    ...
    <div class="absolute right-0 top-0 h-full w-80 max-w-[85vw] bg-white shadow-2xl overflow-hidden">
        ...
        <nav class="flex-1 overflow-y-auto py-4 h-[calc(100vh-120px)]">
            <ul class="space-y-1 px-4">
                ...
                <!-- À propos Dropdown -->
                <li>
                    <button onclick="toggleMobileDropdown('about')" class="w-full flex items-center justify-between px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg transition-all duration-200 font-medium group focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <div id="about-dropdown" class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                        <div class="ml-8 mt-1 space-y-1">
                            <a href="{{ url('/abouts') }}" onclick="closeMobileSidebar()" class="block px-4 py-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-200">Charte</a>
                            <a href="{{ url('/members') }}" onclick="closeMobileSidebar()" class="block px-4 py-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-200">Bureau</a>
                        </div>
                    </div>
                </li>
