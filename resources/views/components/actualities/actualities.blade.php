        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div class="flex justify-center">
                <img
                    ...
                    class="w-80 lg:w-96 shadow-lg rounded-lg"
                />
            </div>


            <div class="text-center lg:text-left text-blue-900 space-y-6">
                <h2 class="text-2xl md:text-4xl font-semibold">
                    Inscrivez-vous ! Plus que
                </h2>

                <!-- Countdown Timer -->
                <div id="countdown" class="flex justify-center lg:justify-start space-x-4 text-center">
                    <div>
                ...
                <div class="flex justify-center lg:justify-start space-x-4 mt-6">
                    <button class="bg-blue-700 hover:bg-blue-900 text-white font-medium py-2 px-4 rounded-lg">
                        Inscription
                    </button>
                    <button class="bg-blue-700 hover:bg-blue-900 text-white font-medium py-2 px-4 rounded-lg">
                        Visiter les stands
